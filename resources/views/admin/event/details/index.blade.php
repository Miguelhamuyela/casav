                            ...
                            <div class="col">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <p class=" text-justify">{!! html_entity_decode($event->body) !!}</p>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-7 mb-2">
                                        <hr>
                                        <p class="mb-1 "><b>Data de Cadastro:</b> {{ $event->created_at }}
                                        </p>
                                        <p class="mb-1 "><b>Última Actualização:</b> {{ $event->updated_at }}
                                        </p>
