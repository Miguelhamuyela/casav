...
@section('titulo', 'Recrutamento e Selecção de Membros das Mesas das Assembleias de Voto para as Eleições Gerais de 2022')
@section('content')
    <!-- ====== Banner Start ====== -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ud-banner-content">
                        ...
                        <h1> Recrutamento e Selecção de Membros das Mesas das Assembleias de Voto <br> para as Eleições Gerais de 2022</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-5 d-none d-md-none d-lg-block">
                    <img src="/site/images/candidacy/third.jpeg" width="100%" alt="">
                </div>
