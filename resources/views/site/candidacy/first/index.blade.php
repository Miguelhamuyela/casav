...
@section('titulo', 'Recrutamento e Selecção de Candidatos a Digitalizadores para as Eleições Gerais de 2022')
@section('content')
    <!-- ====== Banner Start ====== -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ud-banner-content">
                        ...
                        <h1> Recrutamento e Selecção de Candidatos a Digitalizadores <br> para as Eleições Gerais de 2022</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-5 d-none d-md-none d-lg-block">
                    <img src="/site/images/candidacy/first.jpeg" width="100%" alt="">
                </div>
                <div class="col-lg-7 col-md-12">
                    ...
                    <div class="col-12 alert alert-info mb-5">
                        ...
                        <p>
                            ...
                            seu direito de
                            voto. <br>
                            2. Serão admitidas as candidaturas para o Centro de Escrutínio Nacional os candidatos eleitores
                            da Província de Luanda! <br>
                            3. Será automaticamente desqualificado se prestar falsas declarações! <br>
                            4. (<b class="text-danger">*</b>) - Campo Obrigatório
                        </p>
                    </div>
                    @if ($errors->any())
