            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ud-banner-content">
                        <h1>Termos de Uso & <br> Políticas de Privacidade</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-5">
                    <h2 class="ud-blog-details-title">
                        O acesso ou a utilização do site implica a aceitação pelo utilizador das
                        condições
                    ...
                    <div style="text-align:justify;" class="col-md-12 text-justify my-5">
                        ...
                        <div class="row">
                            <p class="mt-3">
                                ...
                                Condições de
                                Utilização,
                                destina-se a regular o processo de tratamento de dados pessoais a realizar pela CNE por
                                conta da
                                utilização
                                deste website. <br>
                            ...
                            <br><br>
                            A CNE não efetuará o tratamento de dados pessoais que revelem a origem racial ou étnica, as
                            opiniões
                            ...
                            <ul class="mt-3">
                                ...
                                <li>O titular dos dados solicite um serviço, responda a um inquérito, ou mais informações
                                    sobre um
                                    programa através de formulário e/ou chatbot ou troque correspondência eletrónica com a
                                    CNE.
                                </li>
                            ...
                            <p class="mt-3">
                                ...
                                A CNE dará o seu consentimento prévio relativamente à recepção de comunicações comerciais
                                para fins
                                de
                                marketing, sendo-lhe conferida a
                                faculdade de oposição, a todo o tempo, mediante comunicação escrita dirigida a CNE. <br>
                                As referidas informações comerciais, poderão ser enviadas pela CNE, através de correio
                                eletrónico,
                                telefone, SMS
                            ...
                            <p class="mt-3">
                                ...
                                protecção dos seus próprios interesses, A CNE não partilhará quaisquer dados pessoais com
                                entidades
                                terceiras.
                            </p>
                            <p class="mt-3">
                            ...
                            <p class="mt-3">
                                <b>Cookies</b><br>
                                A CNE poderá utilizar cookies no seu website com o objectivo de melhorar a qualidade do
